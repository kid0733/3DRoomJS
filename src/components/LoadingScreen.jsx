...
export const LoadingScreen = (props) => {
    ...
    return (
        <>
            <div
            className={`fixed top-0 left-0 w-full h-full z-50 transition-opacity duration-1000 pointer-events-none flex flex-col items-center justify-center bg-indigo-50 ${started ? "opacity-0" : "opacity-100"}`}
        >
